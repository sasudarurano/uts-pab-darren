...
class TimnasIndonesiaPage extends StatefulWidget {
  const TimnasIndonesiaPage({super.key});

  @override
  _TimnasIndonesiaPageState createState() => _TimnasIndonesiaPageState();
}

class _TimnasIndonesiaPageState extends State<TimnasIndonesiaPage> {
